...
//Função para realizar o disparo
function disparo() {
  if (podeAtirar == true) {
    somDisparo.play();
    podeAtirar = false;
...
//Função para verificar colisão com o inimigo
function colisao() {
...
//Função para executar a Explosão 1
...
function gameOver() {
  ...
  $("#fim").html(
    "<h1> Game Over </h1><p>Sua pontuação foi: " +
      pontos +
      "</p>" +
      "<div id='reinicia'><a href='index.html'><h3>Jogar Novamente</h3></a></div>"
  );
